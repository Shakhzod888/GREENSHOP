...
import Flower from "../assets/planet_1_1.png";
import Flower_2 from "../assets/planet_1_2.png";
    ...
    <>
      <Box className="main_page">
        <header className="main_page_header">
          ...
          <Flex gap={50}>
            <Text className="header_links header_active_link">Home</Text>
            <Text className="header_links">Shop</Text>
            <Text className="header_links">Plant Care</Text>
            <Text className="header_links">Blogs</Text>
          </Flex>
          <Flex justify={"center"} align={"center"} gap={33}>
            <Box>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
        ...
        <Flex
          ...
          className="main_box"
        >
          <Flex justify={"center"} align={"center"} h={"70vh"} w={"50%"}>
            <Box pos={"relative"} left={60}>
              <Text c={"#3D3D3D"} fz={15} fw={500} lts={1.5}>
                WELCOME TO GREENSHOP
              </Text>
              <Title pt={5} fw={900} c={"#3D3D3D"} lh={1.2} fz={70} order={3}>
                LET’S MAKE A BETTER{" "}
                <Text span c="#46A358" inherit>
                  PLANET
                </Text>
              </Title>
              <Text pt={5} c={"#727272"} fz={15} fw={500} lh={1.6} lts={1}>
                We are an online plant shop offering a wide range of cheap and
                trendy plants. <br /> Use our plants to create an unique Urban
                Jungle. Order your favorite plants!
              </Text>
              <Button mt={35} w={140} h={40} color="#46A358">
                <Text pt={3} fz={16} fw={700}>
                  SHOP NOW
                </Text>
              </Button>
            </Box>
          ...
          <Flex justify={"center"} align={"center"} h={"70vh"} w={"50%"}>
            <img className="flower_mini" src={Flower} alt="" />
            <img src={Flower} alt="" />
          </Flex>
        </Flex>
      </Box>
